...
miniapp.post('/User/BookMyTicket', function (req, res) {
    var RupeeSymbol = '/- Rs';
    req.app.locals.PageName = 'BookATicket';
    //Step 1: subtract the total seats from seating_capacity
    var emailId = req.session.LoggedinEmailId;
    console.log('booking emailid'+req.session);
    ...
    db.query(insertQuery, bookingData, function (err, result) {
        ...
        if (result.affectedRows > 0) {
            ...
            res.render('../views/User/BookingConfirmation', {
                MovieName: movieName,
                Language: language,
